    ...
    function Team(name) {
        ...
        this.addGame = (thisScore, otherScore, otherIndex) => {
            if(thisScore > otherScore) {
                ...
                this.pts+=3
                this.last5 = "W" + this.last5.substring(0, this.last5.length-1)
            }
                ...
                this.ga+=otherScore
                this.gd=this.gf-this.ga
                this.last5 = "L" + this.last5.substring(0, this.last5.length-1)
            }
            else{
                this.d++
                this.gf+=thisScore
                this.ga+=otherScore
                this.pts++
                this.last5 = "D" + this.last5.substring(0, this.last5.length-1)
            }
